seqfile = Final.faa * sequence data file name
      outfile = Spirochetes * main result file name
     treefile = RAxML_bestTree.PAML_bootstrap_tree * tree structure file name
