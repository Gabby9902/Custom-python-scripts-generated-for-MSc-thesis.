...
work_dir="/home/gabby/2018_003M" #work_dir is where your input files are and where the output will go

assembly="/home/gabby/2018_003M/2018_003M_scaffolds.fasta" #assembly is the metagenome fasta file with a full path to where this file is located

ncbi="/home/sam/Databases" #ncbi is the full path to where the NCBI databases are found. This does not include the file name.

marker_db="/home/gabby/Tools/Autometa/autometa/databases/markers" #marker spcifies were the marker files are. They should have been downloaded with autometa.

simpleName="2018_003M" #A prefix for all output files specific to your sample
